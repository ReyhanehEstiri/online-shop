...
function Basket() {
  ...
  const removeItem = async (bookId, userId) => {
    try {
      const response = await fetch('https://d6a5-217-218-145-215.ngrok-free.app/api/v1/Book/RemoveBookFromCart', {
        method: 'DELETE',
        headers: {
          'accept': '*/*',
  ...
  const handlePurchase = async () => {
    try {
      const response = await fetch('https://d6a5-217-218-145-215.ngrok-free.app/api/v1/Book/PurchaseUserCart', {
        method: 'POST',
        headers: {
          'accept': '*/*',
        },
